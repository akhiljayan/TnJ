...
//        var linksContainer = jQuery('#links'),
//            baseUrl;
//        // Add the demo images as links with thumbnails to the page:
//        jQuery.each(result.photos.photo, function (index, photo) {
//            baseUrl = 'http://farm' + photo.farm + '.static.flickr.com/' +
//                photo.server + '/' + photo.id + '_' + photo.secret;
//            jQuery('<a/>')
//                .append(jQuery('<img>').prop('src', baseUrl + '_s.jpg'))
...
//    });
    ...
    jQuery('#borderless-checkbox').on('change', function () {
        var borderless = jQuery(this).is(':checked');
    ...
    jQuery('#fullscreen-checkbox').on('change', function () {
        jQuery('#blueimp-gallery').data('fullScreen', jQuery(this).is(':checked'));
    });
